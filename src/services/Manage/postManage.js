...
//查询人员基本信息
export function QuerypersonnelBaseInfo(csdata) {
    return new Promise((resolve, reject) => {
        http({
                url: API.QuerypersonnelBaseInfo_API,
                method: 'POST',
                data: csdata
...
//新增人员基本信息
export function addpersonnelBaseInfo(csdata) {
    return new Promise((resolve, reject) => {
        http({
                url: API.SavepersonnelBaseInfo_API,
                method: 'POST',
                data: csdata
...
//删除人员基本信息
export function deletepersonnelBaseInfo(csdata) {
    return new Promise((resolve, reject) => {
        http({
                url: API.deletepersonnelBaseInfo_API,
                method: 'POST',
                data: csdata
