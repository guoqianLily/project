...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      path: "/taskfeedback",
      meta: { navShow: true, navNone: false },
      component: () => import("../pages/taskFeedback/index.vue")
    },
    {
      name: "filesUploadDown", //附件上传及下载
      path: "/filesUploadDown",
      meta: { navShow: true, navNone: false },
      component: () => import("../components/progessReport/filesUploadDown.vue")
    },
    {
    ...
    },
    {
      ...
      path: "/policyRequire",
      meta: { navShow: true, navNone: false },
      component: () => import("../components/progessReport/policyRequire.vue")
    },
    {
      name: "detail", //导出页面
      path: "/detail",
      meta: { navShow: true, navNone: false },
      component: () => import("../pages/taskFeedback/detail.vue")
    },
    {
      name: "newModification", //政策需求
      path: "/newModification",
      meta: { navShow: true, navNone: false },
      component: () => import("../pages/taskFeedback/Newmodification.vue")
    },
    {
      name: "login", //登录
      path: "/login",
          ...
          children: [
            {
              ...
              component: () =>
                import(
                  "../manage/personnelBaseInfo/actions/personnelBaseInfoCk.vue"
                )
            },
            {
              ...
              component: () =>
                import(
                  "../manage/personnelBaseInfo/actions/personExpirationOfContract.vue"
                )
            }
          ]
        }
...
router.beforeEach((to, from, next) => {
  ...
  if (nextRoute.indexOf(to.name) >= 0 && to.name != null) {
    //判断该页面是否需要登陆
    if (!obj.AdminToken) {
      //判断登陆状态
