  ...
  <div class="managePage" v-loading="loading" element-loading-text="拼命加载中" element-loading-background="rgba(255, 255, 255, 1)">
    <el-container>
      <el-aside width="200" style="background-color: rgb(238, 241, 246)">
        <div style="text-align:right;background-color:rgb(240, 246, 246);"><el-checkbox-button style="display:inline-block;width:100%;" v-model="isCollapse" @change="radioChange" size="small"><i class="el-icon-s-fold"></i></el-checkbox-button></div>
