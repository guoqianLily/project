      ...
      <el-form :model="addForm" ref="addForm" :rules="rules" label-position="right">
        <el-form-item label="政策分类">
          <el-select v-model="addForm.policyType" porp="policyType" placeholder="请选择" @change="getVal">
            <el-option v-for="item in searchForm.policyType" :key="item.id" :label="item.value" :value="item.key">
            </el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="政策内容" prop="content" class="autoElform">
          ...
          <quillEditor @on-change-content="getcontent1" :content="addForm.content" style="height:160px;" ref="content">
          </quillEditor>
        </el-form-item>
        <el-form-item label="进度需求" prop="deadLine" class="autoElform">
          <quillEditor @on-change-content="getcontent2" :content="addForm.deadLine" style="height:120px;"
            ref="deadLine">
          </quillEditor>
        </el-form-item>
        <el-form-item label="对接部门" prop="dockingDepartment" class="autoElform">
          <quillEditor @on-change-content="getcontent3" :content="addForm.dockingDepartment" style="height:120px;"
